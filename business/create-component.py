...
'''
stacks_info = Component(name='Stacks Info', inputs=[input_stacks_info], outputs=[output_stacks_info], description=doc_stacks_info, group="Docker-Utils Info", configured=True)
...
'''
stacks_name = Component(name='Stacks Name', inputs=[input_stacks_name], outputs=[output_stacks_name], description=doc_stacks_name, group="Docker-Utils Info", configured=True)
...
'''
stack_inspect = Component(name='Stack Inspect', args=[name_stack_inspect], inputs=[input_stack_inspect], outputs=[output_stack_inspect], description=doc_stack_inspect, group="Docker-Utils Info", configured=False)
...
'''
export_stack = Component(name='Export Docker-Compose', args=[id_export], inputs=[input_export], outputs=[output_export], description=doc_export, group="Docker-Utils Import/Export", configured=False)
...
'''
import_stack = Component(name='Import Docker-Compose', args=[name_import, file_import], inputs=[input_import], outputs=[output_import], description=doc_import, group="Docker-Utils Import/Export", configured=False)
...
'''
volumes = Component(name='Volumes List', inputs=[input_volumes], outputs=[output_volumes], description=doc_volumes, group="Docker-Utils Host info", configured=True)
...
'''
registries = Component(name='Registries List', inputs=[input_registries], outputs=[output_registries], description=doc_registries, group="Docker-Utils Host info", configured=True)
...
'''
docker_images = Component(name='Search images in Livetech Registry', args=[select_docker_registry, search_docker_images], inputs=[input_docker_images], outputs=[output_docker_images], description=doc_docker_images, group="Docker-Utils Registry/Pypiserver", configured=False)
...
*(for example, you can insert \"stor\" to searching \"storage\")*
'''
python_lib = Component(name='Search libraries in Livetech Pypiserver', args=[select_python_lib, search_python_lib], inputs=[input_python_lib], outputs=[output_python_lib], description=doc_python_lib, group="Docker-Utils Registry/Pypiserver", configured=False)
...
'''
stack_pause = Component(name='Stack Pause', args=[name_stack_pause], inputs=[input_stack_pause], outputs=[output_stack_pause], description=doc_stack_pause, group="Docker-Utils Pause/Unpause", configured=False)
...
You can use \"Stack Info\" extension to take stack's ID.
'''
stack_unpause = Component(name='Stack Unpause', args=[name_stack_unpause], inputs=[input_stack_unpause], outputs=[output_stack_unpause], description=doc_stack_unpause, group="Docker-Utils Pause/Unpause", configured=False)
